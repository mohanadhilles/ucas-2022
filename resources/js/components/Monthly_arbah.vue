 ...
 <div class="main_content inner">
    ...
    <div class="report expense-report">
        <div class="div-title" style="background-color: #8e4449;">
            <span class="arbah-icon">الأرباح الشهرية</span>
            <!-- <span><router-link to="#"><i class="fa fa-gear"></i> اعدادات</router-link></span> -->

        </div>
        <div class="tables_ms">
             <input type="month" value="" min="2020-06" v-model="Search" @change="filteredpro()">
            <div>
                <table style="margin-top: 8px;" class="table sms-table">
                    <thead>
                        <tr>
                            <th style="width:17px;border-right:none;background-color: #8e4449;">#</th>
                            <th style="width:157px;background-color: #8e4449;">الصنف</th>
